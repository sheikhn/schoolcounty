...
class Filter extends Component {
    ...
    setName(e) {
        this.props.setFilterParams({'name': e.target.value})
    }


    render() {
        let {filterParams, filter} =  this.props;
						...
						<div class="sidebarInner sidebarCategory">
							<div class="panel panel-default">
								...
								<div class="input-group">
									<input onKeyUp={(event) => this.setName(event)} type="text" class="form-control" defaultValue={filter.name}  placeholder="What are you looking for?" aria-describedby="basic-addon2" />
