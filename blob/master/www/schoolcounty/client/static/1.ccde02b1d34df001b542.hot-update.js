	...
	var schools = function schools() {
	    ...
	    switch (action.type) {
	        ...
	        case 'GET_FILTER_STATES_SUCCESS':
	            ...
	            var newSchoolFilter = (0, _extends3.default)({}, schoolFilter.states, {
	                fetched: true,
	                list: action.payload.states
	            });
	            state.schoolFilter = newSchoolFilter;
	            return state;
	
	        case 'GET_FILTER_LEVELS_SUCCESS':
	            (0, _extends3.default)({}, schoolFilter.level, {
	                fetched: true,
	                list: action.payload.states
	            });
...
//# sourceMappingURL=1.ccde02b1d34df001b542.hot-update.js.map