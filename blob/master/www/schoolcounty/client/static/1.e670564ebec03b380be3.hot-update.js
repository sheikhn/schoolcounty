	...
	var Filter = function (_Component) {
	    ...
	    (0, _createClass3.default)(Filter, [{
	        ...
	        value: function getLevels() {
	            ...
	            for (var levelIndex in levels) {
	                ...
	                levelList.push(_react2.default.createElement(
	                    ...
	                    _react2.default.createElement('label', { className: 'radio-label', htmlFor: 'radio' + typeIndex })
	                )
	        ...
	        value: function render() {
	            ...
	            console.log(filterParams.states);
	            console.log(filterParams.level.fecthed);
...
//# sourceMappingURL=1.e670564ebec03b380be3.hot-update.js.map