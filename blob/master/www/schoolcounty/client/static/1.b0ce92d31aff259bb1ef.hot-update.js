	...
	var Filter = function (_Component) {
	    ...
	    (0, _createClass3.default)(Filter, [{
	        ...
	        value: function getSyllabus() {
	            ...
	            for (var _syllabusIndex in syllabusTypes) {
	                var syllabusType = syllabusTypes[_syllabusIndex];
	                syllabusList.push(_react2.default.createElement(
	                    "option",
	                    { key: _syllabusIndex, value: '.option' + _syllabusIndex },
	                    syllabusType
	                ));
	            }
	        ...
	        value: function getStates() {
	            ...
	            var stateList = [];
	            var states = filterParams.states;
	            for (var stateIndex in states) {
	                var state = statess[stateIndex];
	                stateList.push(_react2.default.createElement(
	                    "option",
	                    { key: syllabusIndex, value: '.option' + stateIndex },
	                    state
	                ));
	            }
...
//# sourceMappingURL=1.b0ce92d31aff259bb1ef.hot-update.js.map