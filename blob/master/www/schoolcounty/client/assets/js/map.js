function initialize() {
    function e(e) {
        ...
        t.addListener("domready", function() {
            ...
            var s = new google.maps.LatLng(l.latitude, l.longitude),
                n = "";
...
var mapStyles = [{
    ...
    center = new google.maps.LatLng(-33.924351, 151.156788),
    existId = document.getElementById("map-canvas");
