        ...
        return this.each(function() {
            ...
            if (!o) {
                var p = n(this, "date"),
                    ...
                    g = r(f.language),
                    D = t.extend({}, u, g, p, c);
                if (h.is(".input-daterange") || D.inputs) {
                    var v = {
                        inputs: D.inputs || h.find("input").toArray()
                    };
                    h.data("datepicker", o = new l(this, t.extend(D, v)))
                } else h.data("datepicker", o = new d(this, D))
            }
...
}(window.jQuery), $("#sandbox-container .input-daterange").datepicker({});